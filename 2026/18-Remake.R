...
p_bg <- ggplot(data = circles, aes(x = 1, y = 1, size = size)) +
  geom_point(shape = 21, fill = NA, colour = "grey90") +
...
# colours from paltte https://color.adobe.com/s-Presley-color-theme-1560137/
...
ggdraw(p_bg) +
  draw_plot(p_covers, x = -0.05, y = 0.05, scale = 0.5)
...
ggsave(plot = p, filename = "2026/plots/18.png", width = 1200, height = 800, units = "px", bg = "white", scale = 2.5)
